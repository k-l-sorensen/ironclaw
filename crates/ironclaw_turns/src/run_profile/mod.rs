...
pub use host::{
    ...
    CapabilityFailureDetail, CapabilityFailureKind, CapabilityFailureKindValue,
    CapabilityInputIssue, CapabilityInputIssueCode, CapabilityInputRef, CapabilityInputRepair,
    CapabilityInvocation, CapabilityOutcome, CapabilityProgress, CapabilityRecoveryDetail,
    CapabilityRecoveryHint, CapabilityResultMessage, CapabilitySurfaceVersion, ConcurrencyHint,
    ...
    LoopTranscriptPort, ModelStreamChunk, ModelVisibleCapabilityError, ParentLoopOutput,
    ProcessHandleSummary, PromptMode, ProviderToolCall, ProviderToolCallCapabilityIds,
    ProviderToolCallReference, ProviderToolCallReplay, ProviderToolDefinition, RecoveryConstraints,
    SameCallRetryConstraint, StageCheckpointPayloadRequest, UpdateAssistantDraft,
