...
registerPack("ko", {
  ...
  "chat.send": "메시지 보내기",
  "chat.attachmentsUnsupported": "WebChat v2는 아직 이미지 또는 파일 첨부를 지원하지 않습니다. 첨부 파일을 제거하고 원하는 내용을 텍스트로 설명하세요.",
  ...
  "automations.summary.failuresDetail": "표시된 기록의 실패한 실행입니다.",
  "automations.summary.running": "현재 실행 중",
  "automations.summary.runningDetail": "현재 진행 중인 실행입니다.",
