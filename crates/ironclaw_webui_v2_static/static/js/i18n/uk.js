...
registerPack("uk", {
  ...
  "chat.attachmentsUnsupported": "WebChat v2 ще не підтримує вкладення зображень або файлів. Видаліть вкладення та опишіть те, що ви хочете, у тексті.",
  ...
  "automations.summary.failuresDetail": "Невдалі запуски у видимій історії.",
  "automations.summary.running": "Виконується зараз",
  "automations.summary.runningDetail": "Запуски, що виконуються зараз.",
