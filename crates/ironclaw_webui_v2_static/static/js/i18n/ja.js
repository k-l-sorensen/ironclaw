...
registerPack("ja", {
  ...
  "chat.send": "送信",
  "chat.attachmentsUnsupported": "WebChat v2 はまだ画像またはファイルの添付ファイルをサポートしていません。添付ファイルを削除し、必要な内容をテキストで説明します。",
  ...
  "automations.summary.failuresDetail": "表示中の履歴にある失敗した実行。",
  "automations.summary.running": "現在実行中",
  "automations.summary.runningDetail": "現在進行中の実行。",
