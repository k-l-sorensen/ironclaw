...
registerPack("zh-CN", {
  ...
  "chat.send": "发送消息",
  "chat.attachmentsUnsupported": "WebChat v2 暂不支持图像或文件附件。请删除附件并用文本描述您的需求。",
  ...
  "automations.summary.failuresDetail": "可见历史中的失败运行。",
  "automations.summary.running": "正在运行",
  "automations.summary.runningDetail": "当前正在进行的运行。",
