...
I18n.register('en', {
  ...
  'chat.fileTooBig': 'File "{name}" exceeds 7 MB limit ({size} MB)',
  'chat.videoNotSupported': 'Video file "{name}" is not supported. Please attach images, audio, PDFs, or documents instead.',
