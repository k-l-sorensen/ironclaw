...
use ironclaw_turns::{
    ...
    run_profile::{
        ...
        CapabilityBatchInvocation, CapabilityCallCandidate, CapabilityInvocation,
        CapabilityOutcome, CapabilityResultMessage, FinalizeAssistantMessage, LoopCheckpointKind,
        LoopCheckpointRequest, LoopDriverNoteKind, LoopGateKind, LoopInput, LoopModelRequest,
        LoopProgressEvent, ParentLoopOutput, StageCheckpointPayloadRequest,
...
impl CanonicalAgentLoopExecutor {
    ...
    async fn checkpoint_and_exit_if_cancelled(
        ...
        match self.checkpoint(host, state, CheckpointKind::Final).await {
            ...
            {
                Ok(CancelCheck::Exit(cancelled_exit(host, None)?))
            }
...
mod tests {
    ...
    use ironclaw_turns::{
        ...
        run_profile::{
            ...
            LoopDriverId, LoopInputBatch, LoopInputCursor, LoopModelMessage, LoopModelResponse,
