...
use ironclaw_product_adapters::{
    ...
    EgressCredentialHandle, EgressRequest, EgressResponse, ExternalActorRef, OutboundDeliverySink,
    ProductAdapter, ProductAdapterId, ProtocolHttpEgress, ProtocolHttpEgressError, RedactedString,
};
use ironclaw_product_workflow::{
    ApprovalInteractionService, AuthInteractionService, DefaultInboundTurnService,
    DefaultProductWorkflow, ProductActorUserResolutionRequest, ProductActorUserResolver,
    ...
    ProductWorkflowError, RebornOutboundDeliveryTargetId, RebornServicesError,
    RebornServicesErrorCode, RebornServicesErrorKind, StaticProductInstallationResolver,
...
use ironclaw_turns::{ReplyTargetBindingRef, TurnCoordinator};
...
use crate::slack_serve::{
    ResolvedSlackIngress, SlackEventsRouteState, SlackIngressError, SlackInstallationRecord,
...
impl SlackHostBetaRuntimeParts {
    fn from_runtime(runtime: &RebornRuntime) -> Result<Self, SlackHostBetaBuildError> {
        ...
        Ok(Self {
            ...
            approval_interaction_service: runtime.webui_approval_interaction_service(),
