...
impl LlmProvider for MistralProvider {
    ...
    fn cost_per_token(&self) -> (Decimal, Decimal) {
        // TODO(fork #9): `costs::is_local_model` matches `mistral*` and returns
        // zero, so hosted Mistral currently bills as $0. Add real Medium 3.5 /
        // Small 4 pricing + tighten the local heuristic.
