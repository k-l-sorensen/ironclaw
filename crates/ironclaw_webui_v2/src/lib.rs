...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_RESOLVE_GATE, WEBUI_V2_ROUTE_RETRY_RUN, WEBUI_V2_ROUTE_SEARCH_SKILLS,
...
pub use handlers::{
    ...
    remove_extension, remove_skill, resolve_gate, retry_run, run_operator_service_lifecycle,
