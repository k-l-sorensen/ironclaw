...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_DELETE_PROJECT, WEBUI_V2_ROUTE_DELETE_THREAD,
    WEBUI_V2_ROUTE_DISCARD_PENDING_SKILL, WEBUI_V2_ROUTE_GET_ATTACHMENT,
...
pub use handlers::{
    ...
    complete_nearai_wallet_login, create_thread, delete_llm_provider, delete_thread,
    discard_pending_skill, get_attachment, get_extension_setup, get_llm_config,
    ...
    set_active_llm, set_auto_activate_learned, set_learning_enabled, set_operator_config_key,
    set_outbound_preferences, set_require_review, set_skill_auto_activate, setup_extension,
