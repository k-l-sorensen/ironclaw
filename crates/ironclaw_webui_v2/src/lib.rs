...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_OPERATOR_DIAGNOSTICS, WEBUI_V2_ROUTE_OPERATOR_GET_SETUP,
...
pub use handlers::{
    ...
    get_operator_diagnostics, get_operator_setup, get_operator_status, get_session, get_timeline,
    install_extension, list_automations, list_connectable_channels, list_extension_registry,
    list_extensions, list_llm_models, list_operator_config, list_threads, query_operator_logs,
    remove_extension, resolve_gate, run_operator_service_lifecycle, run_operator_setup,
